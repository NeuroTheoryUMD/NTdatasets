...
class SimCloudData(SensoryBase):
    """
    Data set for simulted cloud data. It is assumed that the data has already been 
    compiled as an HDF5 file.
    """
    ...
    def __init__(self,
        ...
        #self.block_inds = np.arange(self.NT, dtype=np.int64).reshape(self.NB,self.block_len) 
        self.block_inds = [None]*self.NB
